<#
.SYNOPSIS
    One-click installer and launcher for Intune OEMConfig App Version Audit via Microsoft Graph
...
Write-Host "    Intune OEMConfig App Version Audit via Microsoft Graph" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-oemconfig-app-version-audit.ps1"
